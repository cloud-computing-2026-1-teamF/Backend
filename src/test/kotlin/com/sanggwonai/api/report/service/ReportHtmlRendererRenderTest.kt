...
class ReportHtmlRendererRenderTest {
    ...
    fun `샘플 보고서 HTML 렌더`() {
        ...
        assertTrue(html.contains("왜 이 예상 생존율인가"), "v6.3 점수 분해가 렌더되지 않음")
    ...
    fun `v6_5 매물별 탭 보고서 HTML 렌더`() {
        ...
        assertTrue(html.contains("예상 생존율"), "예상 생존율 용어 누락")
        assertTrue(!html.contains("입지 점수"), "옛 라벨 '입지 점수'가 남아있음(전면 통일 위반)")
        // 매물 탭
    ...
    companion object {
        ...
        private val REPORT_JSON = """
        {
          ...
          "chapter_1_executive_summary": {
            ...
            "점수_분해": {"값":"예상 생존율 64%는 풍부한 유동인구와 평균을 웃도는 매출에서 올라왔지만, 평균의 약 4배에 달하는 동종 경쟁과 높은 월세가 생존율을 끌어내렸습니다."},
          ...
          "chapter_3_top3_property_analysis": {
            "chapter_intro": {"값":"세 매물 모두 예상 생존율 64%로 기본 수요는 동일합니다. 최종 선택은 월세·층·투자회수 차이로 좁힙니다."},
            "매물_상세_분석": [
          ...
          "chapter_5_location_history": {
            "점수_추세_해석": {"값":"이 일대 예상 생존율은 2020년 코로나기에 56%까지 내렸다가 2024년 64%로 회복했습니다. 하락이 아닌 완만한 회복 국면입니다."},
        ...
        private val REPORT_JSON_V65 = """
        {
          ...
          "comparison_overview":{
            "인트로":"서교동 일대에서 추린 세 매물입니다. 예상 생존율은 69~78%로 기본 수요는 비슷하지만, 월세·층·수익성에서 성격이 크게 갈립니다. 하나가 정답이라기보다, 본인의 예산·콘셉트·리스크 성향에 맞는 자리를 고르는 관점으로 보시면 좋습니다.",
            "매물_성격":[
          ...
          "property_reports":[
            {"rank":1,
             "요약":{"한_줄_평가":"1층 코너로 노출은 최고지만 고정비 부담이 큰 자리입니다.","종합_해석":"동교로 194는 1층 코너 입지로 유동 노출이 세 매물 중 가장 좋아 초기 인지도 확보에 유리합니다. 다만 월세 1,400만원으로 고정비가 과다해 현재 추정 매출로는 월 순이익이 적자로 잡힙니다. 풍부한 유동을 회전으로 바꾸는 점심 정식·테이크아웃 설계가 흑자 전환의 관건입니다.","점수_분해":"예상 생존율 78%는 풍부한 유동인구와 평균을 웃도는 점포당 매출이 끌어올렸고, 평균의 약 4배에 달하는 동종 경쟁과 높은 월세가 일부 깎았습니다.","미래_전망":"1년 전망은 85%로 높지만 5년으로 갈수록 64%까지 낮아져, 경쟁 과밀 속 중장기 차별화가 관건입니다.",
             ...
             "내력":{"점수_추세_해석":"이 자리 예상 생존율은 2020년 62%까지 내렸다가 2024년 78%로 꾸준히 회복했습니다.","업종_교체_패턴_해석":"거쳐간 가게가 일식·중식에 몰려 있고 대부분 3년 안팎에 교체된 점은, 해당 업태가 오래 자리 잡기 어려웠음을 시사합니다.","종합_판정":"입지는 회복 중이나 짧은 존속이 반복된 자리이므로, 단명했던 업태를 피하고 콘셉트를 좁히면 과거 패턴을 비껴갈 여지가 있습니다."},
            ...
            {"rank":2,
             "요약":{"한_줄_평가":"월세가 가장 낮아 흑자 전환이 가장 빠른 자리입니다.","종합_해석":"동교로 195는 월세 190만원으로 고정비가 가장 낮아 회수 11개월로 흑자 전환 여력이 가장 큽니다. 지하1층이라 노출·환기·간판 가시성은 약점이며, 분위기·데이트·가벼운 술 수요가 두드러져 저녁 사케·안주 중심 콘셉트가 잘 맞습니다.","점수_분해":"예상 생존율 72%는 낮은 월세가 가장 크게 끌어올렸고, 지하 노출과 경쟁 과밀이 생존율을 일부 깎았습니다.","미래_전망":"1년 80%에서 5년 61%로 완만히 낮아져, 저비용 구조를 유지하며 단골을 만드는 운영이 중요합니다.",
             ...
             "내력":{"점수_추세_해석":"이 자리 예상 생존율은 2020년 58%에서 2024년 72%로 회복세입니다.","업종_교체_패턴_해석":"주점·일식이 거쳐갔고 평균 3년가량 존속했습니다. 술 수요와 맞는 업태가 비교적 오래 버틴 자리입니다.","종합_판정":"저녁·술 수요에 맞춘 콘셉트라면 과거 흐름과 자연스럽게 이어집니다."},
            ...
            {"rank":3,
             "요약":{"한_줄_평가":"중간 임대에 2층 테라스를 갖춘 균형형 자리입니다.","종합_해석":"동교로25길 34는 임대료가 중간 수준이고 2층 90㎡에 테라스를 갖춰 비용과 공간·콘셉트의 균형이 좋습니다. 2층이라 접근성·간판 노출은 보완이 필요하며, 맛·신선도 만족이 강하고 웨이팅 부담이 적어 목적 방문형 콘셉트에 적합합니다.","점수_분해":"예상 생존율 69%는 평균 수준 월세와 안정적 유동이 받쳤고, 동종 경쟁 과밀이 생존율을 일부 깎았습니다.","미래_전망":"1년 76%에서 5년 58%로 낮아져, 테라스·코스 같은 차별 요소로 재방문을 만드는 운영이 필요합니다.",
             ...
             "내력":{"점수_추세_해석":"예상 생존율은 2020년 57%에서 2024년 69%로 회복했습니다.","업종_교체_패턴_해석":"양식이 단명한 뒤 일식이 들어와 영업 중입니다. 업태 적합도가 존속을 좌우한 자리입니다.","종합_판정":"교체가 잦지 않은 자리라, 콘셉트만 맞으면 비교적 안정적으로 운영할 수 있습니다."},
          ...
          "your_choice":{
            ...
            "재확인":"세 자리의 예상 생존율은 69~78% 범위로, 같은 상권이라 입지 여건은 비슷합니다. 최종 선택은 당신의 예산·콘셉트·리스크 성향에 달려 있으니, 위 가이드를 자신의 우선순위에 비춰보세요."
          },
          "chapter_7_appendix":{
            "본_보고서의_한계":"예상 생존율은 AI가 3년 후 영업 가능성(생존 확률)을 예측한 참고 지표이며, 실제 성과는 운영 역량·메뉴 경쟁력에 따라 달라집니다.\n매출·회수는 동네 평균 기반 추정값으로 개별 매물 실제와 다를 수 있습니다.\n본 보고서는 보조 참고 자료이며 현장 실사·전문가 상담을 병행하시기 바랍니다."
          }
        }
        """.trimIndent()
    }
